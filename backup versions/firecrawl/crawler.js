...
const FIRECRAWL_API_KEY = 'fc-195000cba7b24263bb25a10a8328c68d';
const FIRECRAWL_CRAWL_URL = 'https://api.firecrawl.dev/v2/crawl';
const FIRECRAWL_STATUS_URL = 'https://api.firecrawl.dev/v2/crawl/status';
...
async function generateKeywords(productName, description = '') {
  const prompt = `Given the following product information, generate exactly 5 keywords that could be used for categorization. These keywords should describe the product type, category, features, or use case.
...
async function crawl() {
  ...
  const filename = 'product_crawler_results.csv';
